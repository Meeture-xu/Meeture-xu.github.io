  ...
  _gsScope._gsDefine(
    ...
    function (a, b, c) {
      var d,
        ...
        J =
          _gsScope.navigator &&
          -1 !== _gsScope.navigator.userAgent.toLowerCase().indexOf("android"),
        K = 0,
        L = {},
        M = {},
        N = function (a) {
          ...
          return (
            ...
            d
              ...
              : y.isSVG &&
                ...
                (f[4] =
                  parseFloat(f[4]) -
                  (m.xOrigin - (m.xOrigin * f[0] + m.yOrigin * f[2]))),
                (f[5] =
                  parseFloat(f[5]) -
                  (m.yOrigin - (m.xOrigin * f[1] + m.yOrigin * f[3])))),
            b &&
              (void 0 === g && la(),
        ...
        Ta = function (d, g) {
          ...
          var h,
                ...
                for (
                  ...
                  (c = Y(l.parentNode)),
                    ...
                    c &&
                      ...
                      nb(Ma.pointerX + h, Ma.pointerY + j)),
                    (l = b);
              }
              if (ba) {
                var n = Ma.x,
                ...
                p > n && n > -p && (n = 0),
                  p > o && o > -p && (o = 0),
                  za
                    ? ((Ma.deltaX = n - qa.data.rotation),
                      (qa.data.rotation = Ma.rotation = n),
                      qa.setRatio(1))
                    : i
                    ? (Fa && ((Ma.deltaY = o - i.top()), i.top(o)),
                      Ea && ((Ma.deltaX = n - i.left()), i.left(n)))
                    : ya
                    ? (Fa && ((Ma.deltaY = o - qa.data.y), (qa.data.y = o)),
                      Ea && ((Ma.deltaX = n - qa.data.x), (qa.data.x = n)),
                      qa.setRatio(1))
                    : (Fa &&
                        ((Ma.deltaY = o - parseFloat(d.style.top || 0)),
                        (d.style.top = o + "px")),
                      Ea &&
                        ((Ma.deltaY = n - parseFloat(d.style.left || 0)),
                        (d.style.left = n + "px"))),
                  !v ||
                    a ||
                    ua ||
                    ((ua = !0), ja(Ma, "drag", "onDrag"), (ua = !1));
              }
              ba = !1;
            },
            ab = function (a, c) {
              ...
              d._gsTransform ||
                ...
                ya
                  ...
                  : ((Ma.y = parseInt(d.style.top, 10) || 0),
                    (Ma.x = parseInt(d.style.left, 10) || 0)),
                (ea || fa || ga) &&
                  !c &&
                  ...
                  ea &&
                    ((e = ea(Ma.x)),
                    e !== Ma.x &&
                      ((Ma.x = e), za && (Ma.rotation = e), (ba = !0))),
                  fa && ((e = fa(Ma.y)), e !== Ma.y && (Ma.y = e), (ba = !0))),
                ba && _a(!0),
                a ||
                  ((Ma.deltaX = Ma.x - f),
                  (Ma.deltaY = Ma.y - g),
                  ja(Ma, "throwupdate", "onThrowUpdate"));
            },
            bb = function () {
              var a, b, c, e;
              (s = !1),
                i
                  ...
                  : g.bounds &&
                    ...
                    za
                      ? ((Ma.minX = y = a.left),
                        (Ma.maxX = w = a.left + a.width),
                        (Ma.minY = H = Ma.maxY = E = 0))
                ...
                ? (a === !0 &&
                  ...
                  (Ma.tween = h =
                    f.to(
                      ...
                      isNaN(g.minDuration)
                        ? 0 === j ||
                          ("object" == typeof a && a.resistance > 1e3)
                          ? 0
                          : 0.5
                        : g.minDuration,
                      j
                  ...
                  : (hb() ? (ab(!0, !0), bb()) : Ma.applyBounds(),
                    za
                      ? ((Z = Ma.rotationOrigin = Ca(d, { x: 0, y: 0 })),
                        ...
                        (l = Ma.x),
                        (r = Ma.y =
                          Math.atan2(Z.y - Ma.pointerY, Ma.pointerX - Z.x) * z))
            ...
            lb = function (a) {
              ...
              if (
                ...
                if (
                  ...
                  return (
                    Ja(a.target, "change", ob),
                    ja(Ma, "press", "onPress"),
                    void Qa(Ra, !0)
                  );
                if (
                  ((ra =
                    la && Ea !== Fa && Ma.vars.allowNativeTouchScrolling !== !1
                      ? Ea
                        ? "y"
                        : "x"
                      : !1),
                  ...
                  (g.zIndexBoost || (!za && !i && g.zIndexBoost !== !1)) &&
                  ...
                  if (
                    ...
                    ((g !== i && (g > Ga || i > Ga)) || (J && ra === sa)) &&
                      ...
                      Ma.vars.lockAxisOnTouchScroll !== !1 &&
                        ...
                        "function" == typeof Ma.vars.onLockAxis &&
                          Ma.vars.onLockAxis.call(Ma, l)),
                      J && ra === sa))
                  )
                    return void ob(l);
                  Ma.allowEventDefault ||
              ...
              (Ma.pointerX = a),
                  ...
                  : (ma &&
                    ...
                    (Ma.lockAxis || Ma.lockedAxis) &&
                      ...
                      h ||
                        ...
                        h &&
                          "function" == typeof Ma.vars.onLockAxis &&
                          Ma.vars.onLockAxis.call(Ma, Ma.pointerEvent)),
                      "y" === h ? (d = 0) : "x" === h && (c = 0)),
                    (e = l + c * i),
                    (f = r + d * i)),
                ...
                (Ma.x !== e || (Ma.y !== f && !za)) &&
                  (za
                    ...
                    : (Fa && ((Ma.y = Ma.endY = f), (ba = !0)),
                      Ea && ((Ma.x = Ma.endX = e), (ba = !0))),
                  !Ma.isDragging &&
                    Ma.isPressed &&
                    ((Ma.isDragging = !0), ja(Ma, "dragstart", "onDragStart")));
            },
            ob = function (a, c) {
              if (
                h &&
            ...
            qb = function (a) {
              ...
              return (
                f &&
                  (e || (d && Ma.vars.suppressClickOnDrag !== !1)) &&
                  a.stopImmediatePropagation(),
                !c ||
                (Ma.pointerEvent && Ma.pointerEvent.defaultPrevented) ||
                (e && i === h)
                  ? void (
                      (Ma.isPressed || d || c) &&
                      (f
          ...
          (da = Ta.get(this.target)),
            ...
            (this.update = function (a, b, c) {
              ...
              return (
                ...
                Ma.isPressed &&
                  !b &&
                  ((Ea && Math.abs(e - Ma.x) > 0.01) ||
                    (Fa && Math.abs(f - Ma.y) > 0.01 && !za)) &&
                  gb(),
                Ma.autoScroll &&
                  ($(d.parentNode), (Wa = Ma.isDragging), _a(!0)),
            ...
            (this.enable = function (a) {
              ...
              return (
                ...
                f &&
                  "soft" !== a &&
                  f.track(i || d, ya ? "x,y" : za ? "rotation" : "top,left"),
                i && i.enable(),
                (d._gsDragID = e = "d" + G++),
                (F[e] = this),
            ...
            (this.disable = function (a) {
              ...
              return (
                ...
                f &&
                  "soft" !== a &&
                  f.untrack(i || d, ya ? "x,y" : za ? "rotation" : "top,left"),
                i && i.disable(),
                R(_a),
